...
const ArrowLeft = () => (
  <svg viewBox="0 0 100 100" className="w-full h-full text-red stroke-current overflow-visible" fill="none" strokeWidth="6" strokeLinecap="round" strokeLinejoin="round">
      ...
      >
        <div className="absolute inset-1 animate-[spin_10s_linear_infinite]">
          <svg viewBox="0 0 100 100" className="w-full h-full">
            ...
            <text className="text-[11px] font-black tracking-[0.18em] uppercase" fill="var(--color-cream)">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <svg viewBox="0 0 100 100" className="w-10 h-10 text-cream stroke-current overflow-visible" fill="none" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="relative w-full max-w-5xl mx-auto flex flex-col items-center justify-center text-center z-10 mb-28 md:mb-36">
          <div className="w-full flex flex-col items-center relative z-10 space-y-3 md:space-y-6">
            <div className="w-full flex justify-center relative z-30">
              <h1
                className="text-extra-bold text-red leading-[0.85] tracking-tighter m-0 p-0 uppercase"
          ...
          <div className="absolute inset-0 w-full h-full pointer-events-none">
            ...
            <motion.div
              ...
              className="absolute top-[-10%] md:top-[-14%] right-[6%] md:right-[2%] z-30 pointer-events-auto"
            >
            ...
            <div className="absolute bottom-[-46%] right-[36%] md:bottom-[-30%] md:right-[10%] z-40 pointer-events-auto">
              <CircularBadge />
            </div>
          </div>
        </div>
